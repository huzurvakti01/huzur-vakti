  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        Provider(create: (_) => adConsentService),
        ...
        Provider(create: (_) => backgroundAlarmManager..init()),
        Provider(create: (_) => BackgroundAlarmScheduler(manager: backgroundAlarmManager)..init()),
